...
def klasor_sil(klasor_id):
    if session.get('rol') != 'admin':
        flash("Klas�r silme yetkiniz yok.")
        return redirect(url_for('ana_sayfa'))
...
def cop_kutusu():
    if session.get('rol') != 'admin':
        flash("��p kutusunu g�r�nt�leme yetkiniz yok.")
        return redirect(url_for('ana_sayfa'))
...
def klasor_kurtar(klasor_id):
    if session.get('rol') != 'admin':
        flash("Klas�r kurtarma yetkiniz yok.")
        return redirect(url_for('ana_sayfa'))
    ...
    conn.commit()
    conn.close()
    flash("Klas�r ba�ar�yla geri y�klendi.")
...
def klasor_kalici_sil(klasor_id):
    if session.get('rol') != 'admin':
        flash("Kal�c� silme yetkiniz yok.")
        return redirect(url_for('ana_sayfa'))
    ...
    flash("Klas�r ve i�indeki t�m evraklar kal�c� olarak silindi.")
    return redirect(url_for('cop_kutusu'))
